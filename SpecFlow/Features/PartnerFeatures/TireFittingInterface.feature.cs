...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru"), "SpecFlow/Features/PartnerFeatures", "Интерфейс шиномонтажа со стороны мойки", "UI-тесты", ProgrammingLanguage.CSharp, new string[] {
                        "all",
                        "TireFittingInterface"});
